  ...
  <section id="about-me">
    <div class="first">
      ...
      <p>
        ...
        <br><br>
        A partir de mes 9 ans, j'ai commencé à développer en Java pour le jeu Minecraft afin de réaliser des modules additionnels pour ajouter des fonctionalités au jeu (mods et plugins)
        <br><br>
    ...
    <div class="second">
      ...
      <div style="max-width: 25%">
        <h3>L'informatique,<br>mais pas que...</h3>
        <p>En dehors du ma passion pour l'informatique, j'aime faire du sport (salle de sport), de l'audiovisuel (vidéos youtube), de la menuiserie et écouter de la musique.</p>
      </div>
    </div>
  </section>
</template>
